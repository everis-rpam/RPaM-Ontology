...
echo ...summarizing...
java -jar ../saxon9he/saxon9he.jar -o:summary/junk.out -s:mod/UBL-Entities-2.1.gc -xsl:../Crane-gc2obdsummary.xsl config-uri=../config-ubl-2.1.xml "title-prefix=Demo UBL"  "subset-model-regex=UBL-Invoice-2.1"
if %errorlevel% neq 0 goto :done

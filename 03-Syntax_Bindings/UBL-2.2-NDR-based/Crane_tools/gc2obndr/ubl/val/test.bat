...
call validatejson.bat ..\json-schema\maindoc\UBL-Invoice-2.1.json Invoice.json
call validatejson.bat ..\json-schema\maindoc\UBL-Invoice-2.1.json InvoiceBad.json

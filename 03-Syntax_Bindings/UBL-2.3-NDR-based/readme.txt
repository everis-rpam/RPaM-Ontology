...
3. Our proposal is to define a generic `Criterion` model that can be reused in a business-domain-agnostic way. RPaM,
...
5. However, for backwards compatibility reasons, it seems improbable that it can be taken in by version 2.3 of UBL;
...
For the generation of the artefacts we are using Crane's tools. If you need to use them for your own purposes, please:
